...
export class AudioService {
    ...
    constructor() {
        ...
        //document.body.appendChild(this._audio);  //不需要把浏览器原生组件加入document，只需要用它的播放功能
        ...
        //0:单曲循环 1:顺序播放  2:列表循环
           if( this._audio.ended){
             if(this.playMode == 0){
                  ...
                  console.log("顺序播放");
                   this.playData.Style = 0;
                   this.Next();
             }else if(this.playMode == 2){
                   console.log("列表循环");
                   this.playData.Style = 1;
                   this.Next();
             }
           }
      }, 1000);
    ...
    public  changePlayMode(currentPlayMode:number):void{
      this.playMode = currentPlayMode;
    }
